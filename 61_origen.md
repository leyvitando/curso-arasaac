...
![](https://lh3.googleusercontent.com/-G1UfDCZKShg/Tf37Dz8Ub4I/AAAAAAAAAFQ/ruFYlGsG_W0/w640-h320-no/tico.jpg)
<td style="text-align: center;" colspan="2"><pre>Fig. 1.17 Proyecto TICO y Proyecto Comunica</pre></td>
...
![](https://lh5.googleusercontent.com/-Py1MRJlaMzc/UegxRFSn4CI/AAAAAAAAAsQ/0z-KntSN2QQ/w724-h553-no/ARASAAC-+Portal+Aragon%25C3%25A9s+de+la+Comunicaci%25C3%25B3n+Aumentativa+y+Alternativa.jpeg)
<td style="text-align: center;"><pre>**Fig. 1.18 Captura de la página de inicio del Portal ARASAAC**</pre></td>
...
![](https://lh4.googleusercontent.com/-GGdBW7nvHD0/UlL2nH9nX-I/AAAAAAAABUM/g-V8pAed9Zk/w707-h117-no/CC+BY+NC+SA+3.0+ES.png)
<td align="center"><pre>Fig. 1.19 Captura de pantalla de la cabecera de la licencia ([http://creativecommons.org/licenses/by-nc-sa/3.0/es/](http://creativecommons.org/licenses/by-nc-sa/3.0/es/))</pre></td>

Para dar cobertura legal, se optó por una <strong style="text-align: justify;">[licencia Creative Commons (BY-NC-SA](http://creativecommons.org/licenses/by-nc-sa/3.0/es/)) **para todos los recursos contenidos en el mismo. Esta licencia permite la difusión en cualquier ámbito (educativo, sanitario, asistencial, publicaciones, etc.) de los recursos y materiales que ofrece el portal, siempre y cuando se cite al autor (de los materiales, de los pictogramas, vídeos o de las fotografías), la fuente de la que han sido obtenidos y no se haga un uso comercial de éstos o de las obras derivadas. 
...
Cualquier material o recurso que elaboramos con los pictogramas de ARASAAC y que distribuyamos p&uacute;blicamente debe contener los términos que exige la licencia de cita del autor, la fuente y la licencia.&nbsp;

Esto suele hacerse, en el caso de materiales, en la primera página o en el pie de página a&ntilde;adiendo un texto similar a:

**Autor pictogramas:**&nbsp;[Sergio Palao](http://www.palao.es/)&nbsp;**Procedencia:**&nbsp;[ARASAAC](http://arasaac.org/)&nbsp;([http://arasaac.org](http://arasaac.org/))&nbsp;**Licencia:**&nbsp;[CC (BY-NC-SA)](http://creativecommons.org/licenses/by-nc-sa/3.0/es/)
